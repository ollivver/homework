...
/* custom selectBox  initialize */
$(function() {
  $("#hover_select").customselect({
    search:     false,
    hoveropen:  true
  });
});
...
/*drop-down menu */
$(function() {
    /* hide menu items at startup */
    $('.sub-menu').slideUp(100);

    $('.dropdown').hover(
        function(){
            $(this).children('.sub-menu').stop(true, false, true).fadeIn(600);
        },
        function(){
            $(this).children('.sub-menu').stop(true, false, true).fadeOut(600);
        }
    );
});
...
/* changing background colors for drop-down menu (jquery.color plugin) */
$(function(){
...
/* custom checkbox from xiper.net */
$(function(){
